...
class Positions:
    def __init__(self):
        ...
        self.grid1_position_hover = (21.32, 43.5, 58.6, -5.67, 77.34, 22.75) #70)
        ...
        self.grid4_position_hover = (-15.79, 41, 70.32, -4.46, 65.11, -14.44)
        self.arm_bottom = (0, 31.0, 61.5, 0, 45.0, 0)